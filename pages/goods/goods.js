Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://api.douban.com/v2/movie/in_theaters?start=0&count=4',
      method: 'GET',
      header: {
        "Content-Type": "json"
      },
    ...
    wx.request({
      url: 'https://api.douban.com/v2/movie/in_theaters?start=5&count=5',
      method: 'GET',
      header: {
        "Content-Type": "json"
      },
    ...
    wx.request({
      url: 'https://api.douban.com/v2/movie/in_theaters?start=11&count=5',
      method: 'GET',
      header: {
        "Content-Type": "json"
      },
    ...
    wx.request({
      url: 'https://api.douban.com/v2/movie/in_theaters?start=15&count=5',
      method: 'GET',
      header: {
        "Content-Type": "json"
      },
